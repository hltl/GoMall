...
func (x *HealthCheckReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	default:
		offset, err = fastpb.Skip(buf, _type, number)
		if err != nil {
...
func (x *HealthCheckResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_HealthCheckResp[number], err)
}

func (x *HealthCheckResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
...
func (x *HealthCheckReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	return offset
...
func (x *HealthCheckResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *HealthCheckResp) fastWriteField1(buf []byte) (offset int) {
	if x.Status == "" {
		return offset
	}
...
func (x *HealthCheckReq) Size() (n int) {
	if x == nil {
		return n
	}
	return n
...
func (x *HealthCheckResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *HealthCheckResp) sizeField1() (n int) {
	if x.Status == "" {
		return n
	}
...
var fieldIDToName_HealthCheckReq = map[int32]string{}

var fieldIDToName_HealthCheckResp = map[int32]string{
	1: "Status",
}
