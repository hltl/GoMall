...
func (x *GetProductsReq) GetIds() []uint32 {
	if x != nil {
		return x.Ids
	}
	return nil
...
type GetProductsResp struct {
	...
	Products []*Product `protobuf:"bytes,1,rep,name=products,proto3" json:"products,omitempty"`
	Faileds  []uint32   `protobuf:"varint,2,rep,packed,name=faileds,proto3" json:"faileds,omitempty"`
}
...
func (x *GetProductsResp) GetFaileds() []uint32 {
	if x != nil {
		return x.Faileds
	}
	return nil
...
var file_product_proto_rawDesc = []byte{
	...
	0x22, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65,
	0x71, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x03,
	0x69, 0x64, 0x73, 0x22, 0x59, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x75, 0x63, 0x74, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x07, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x73, 0x32, 0xb0,
	...
	0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x1a, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75,
	...
	0x68, 0x6c, 0x74, 0x6c, 0x2f, 0x47, 0x6f, 0x4d, 0x61, 0x6c, 0x6c, 0x2f, 0x72, 0x70, 0x63, 0x5f,
...
var file_product_proto_goTypes = []interface{}{
	...
	(*GetProductsReq)(nil),     // 7: product.GetProductsReq
	(*GetProductsResp)(nil),    // 8: product.GetProductsResp
}
var file_product_proto_depIdxs = []int32{
	...
	1, // 3: product.GetProductsResp.products:type_name -> product.Product
	...
	7, // 6: product.ProductCatalogService.GetProducts:input_type -> product.GetProductsReq
	...
	8, // 10: product.ProductCatalogService.GetProducts:output_type -> product.GetProductsResp
